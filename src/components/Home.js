function Home() {
  return (
    <>
  <div className="container-fluid title-image">
    <div className="row">
  ...
  <div className="container-fluid newsletter">
    <div className="row align-items-center">
      <div className="col-lg-6 col-md-12">
        <div className="mission mb-4 mb-lg-0">
          <p className="slide-up-fade-in5 mb-0">We build hope and serve our community by building and strengthening relationships
            between neighbors,
      ...
      <div className="col-lg-6 col-md-12">
        <div className="signup-box">
          ...
          <button type="button" className="btn btn-outline-light btn-lg signup"><a
              href="https://signup.com/go/vMPDRwB"><span className="signup-btn">Click Here to Sign Up!</span></a></button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div className="container-fluid">
      <div className="row" style={{margin: '30px'}}>
        <div className="col-lg-4 col-md-12">
          ...
          <p className="slide-up-fade-in5">We don't assume what people need. We ask. By starting our relationships
            thoughtfully, we get right to the root of the problem.</p>
        </div>
        <div className="col-lg-4 col-md-12">
          <p className="feature-icon"><i className="fas fa-people-carry"></i></p>
          <h3 className="feature">Supply</h3>
          <p className="slide-up-fade-in5">Once we know the need, we fill the need by connecting people to life-giving
            services and resources.</p>
        </div>
        <div className="col-lg-4 col-md-12">
          <p className="feature-icon"><i className="fas fa-hands-helping"></i></p>
          <h3 className="feature">Support</h3>
          <p className="slide-up-fade-in5">We don't just fill a need once. We build relationships that last a lifetime, so
            we'll always be around when we're needed.</p>
        </div>
      </div>
    </div>
  </div>
